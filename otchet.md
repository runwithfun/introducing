...
```
                ...
                |                     |                     |
        Технический директор   Маркетинг-директор    Финансовый директор
                |                     |                     |
    ___________|___________     _____|_____           _____|_____
   |           |           |   |           |         |           |
Разработчики  QA     DevOps   SMM    Контент    Бухгалтерия  Аналитики
```
...
- Приложение распространяется через App Store и Google Play напрямую конечным пользователям
- Партнеры интегрируются в экосистему через API приложения
- Обратная связь от пользователей собирается через приложение и корпоративный сайт

## 8. Организационные, производственные и финансовые параметры проекта

### Календарный план выполнения работ по проекту

| № этапа | Наименование работ | Сроки выполнения | Стоимость этапа, руб. |
|---------|-------------------|------------------|----------------------|
| 1 | Исследование рынка и аналитика | 1 месяц | 200 000 |
| 2 | Разработка концепции и прототипа | 1,5 месяца | 300 000 |
| 3 | Разработка MVP (iOS) | 3 месяца | 800 000 |
| 4 | Пилотное тестирование | 1 месяц | 150 000 |
| 5 | Разработка Android-версии | 2 месяца | 600 000 |
| 6 | Запуск маркетинговой кампании | 1 месяц | 500 000 |
| 7 | Выход на рынок и сбор обратной связи | 1 месяц | 200 000 |
| 8 | Итерационное улучшение и масштабирование | 6 месяцев | 900 000 |
...
```
                  ┌───────────────────────┐
                  │                       │
Потребности ────▶│                       │───▶ Довольный пользователь
пользователей    │                       │
                  │   Фитнес Трекер      │───▶ Данные о физической
Данные о        ▶│                       │     активности
тренировках      │                       │
                  ...
                  └───────────────────────┘
                          ...
                          │       │
                          ▼       ▼
                  Команда      Технологическая
                разработчиков  инфраструктура
```
...
- **Регулирование в сфере персональных данных** — необходимость соответствия требованиям законодательства разных стран (GDPR, 152-ФЗ)
